...
class fcuModes:
    ...
    def setArm(self):
        ...
        try:
            armService1 = rospy.ServiceProxy('/uav4/mavros/cmd/arming', mavros_msgs.srv.CommandBool)
    ...
    def setStabilizedMode(self):
        ...
        try:
            flightModeService1 = rospy.ServiceProxy('/uav4/mavros/set_mode', mavros_msgs.srv.SetMode)
...
class Controller:
    ...
    def __init__(self):
        ...
        self.p2_waypoints.append([0, 0])
        self.p3_waypoints.append([0, 1])
...
def main():
    ...
    rospy.Subscriber('/uav4/mavros/state', State, cnt1.stateCb)
    rospy.Subscriber('/uav2/mavros/state', State, cnt2.stateCb)
    rospy.Subscriber('/uav3/mavros/state', State, cnt3.stateCb)
    # Subscribe to drone's local position
    rospy.Subscriber('/uav4/mavros/local_position/pose', PoseStamped, cnt1.posCb)
    ...
    # Setpoint publisher
    sp_pub1 = rospy.Publisher('/uav4/mavros/setpoint_position/local', PoseStamped, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        if(not cnt1.wp_started  and not cnt3.wp_started):
